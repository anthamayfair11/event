...
<head>
  ...
  <meta property="og:description" content="2026年2月14日（土）13:00開催！新宿駅から徒歩5分。参加費4,000円（目安）。初めての方も大歓迎です。">
  <meta property="og:image" content="https://shinseihoukei.com/event/assets/images/og-image.png?v=2">
  <meta property="og:url" content="https://shinseihoukei.com/event/requirements/?v=2">
  ...
  <meta name="twitter:description" content="2026年2月14日（土）13:00開催！新宿駅から徒歩5分。参加費4,000円（目安）。初めての方も大歓迎です。">
  ...
  <link rel="stylesheet" href="../assets/css/gallery.css?v=<?php echo filemtime(__DIR__ . '/../assets/css/gallery.css'); ?>">
</head>
<body class="bg-light">
  ...
  <div class="bg-primary text-white py-4 mb-4">
    <div class="container">
      ...
      <!-- メイン告知画像 -->
      <div class="mb-3">
        <img src="../assets/images/main.png?v=<?php echo filemtime(__DIR__ . '/../assets/images/main.png'); ?>"
             alt="イベント告知画像"
  ...
  <div class="container pb-5 mb-5">
    ...
    <!-- ギャラリーセクション -->
    <section class="gallery-section card shadow-sm mb-4">
      <div class="card-body p-4">
        <h2 class="h4 text-center mb-3">
          <span class="me-2">📸</span>あゆちゃんの姿 ♡
        </h2>
        <p class="description">
          あゆ本人の完全同意のもと、普段の惨めな姿を公開中…♡<br>
          こんな女装娘にザーメンをぶっかけたい人は、ぜひ参加を検討してください♪
        </p>
        <p class="warning">
          ⚠️ 無断転載・撮影は厳禁です
        </p>
        ...
        <div class="gallery-grid">
          <!-- 画像1 -->
          <div class="gallery-item" data-image-id="ayu_01">
            <a href="../assets/images/gallery/ayu_01.webp" data-fslightbox="gallery">
              <img src="../assets/images/gallery/ayu_01.webp" alt="女装娘あゆ" loading="lazy">
            </a>
            <p class="caption">ザーメン待機中の惨めなあゆ♡</p>
            <div class="gallery-actions">
              <button class="like-btn" onclick="toggleLike('ayu_01')"><span class="like-icon">♡</span><span class="like-count">0</span></button>
              <button class="comment-btn" onclick="openCommentModal('ayu_01')">💬 <span class="comment-count">0</span></button>
              <button class="view-comments-btn" onclick="viewComments('ayu_01')">📖</button>
            </div>
          </div>
          <!-- 画像2 -->
          <div class="gallery-item" data-image-id="ayu_02">
            <a href="../assets/images/gallery/ayu_02.webp" data-fslightbox="gallery">
              <img src="../assets/images/gallery/ayu_02.webp" alt="女装娘あゆ" loading="lazy">
            </a>
            <p class="caption">今日も便器志願です…</p>
            <div class="gallery-actions">
              <button class="like-btn" onclick="toggleLike('ayu_02')"><span class="like-icon">♡</span><span class="like-count">0</span></button>
              <button class="comment-btn" onclick="openCommentModal('ayu_02')">💬 <span class="comment-count">0</span></button>
              <button class="view-comments-btn" onclick="viewComments('ayu_02')">📖</button>
            </div>
          </div>
          <!-- 画像3 -->
          <div class="gallery-item" data-image-id="ayu_03">
            <a href="../assets/images/gallery/ayu_03.webp" data-fslightbox="gallery">
              <img src="../assets/images/gallery/ayu_03.webp" alt="女装娘あゆ" loading="lazy">
            </a>
            <p class="caption">全身に落書きされちゃった…</p>
            <div class="gallery-actions">
              <button class="like-btn" onclick="toggleLike('ayu_03')"><span class="like-icon">♡</span><span class="like-count">0</span></button>
              <button class="comment-btn" onclick="openCommentModal('ayu_03')">💬 <span class="comment-count">0</span></button>
              <button class="view-comments-btn" onclick="viewComments('ayu_03')">📖</button>
            </div>
          </div>
          <!-- 画像4 -->
          <div class="gallery-item" data-image-id="ayu_04">
            <a href="../assets/images/gallery/ayu_04.webp" data-fslightbox="gallery">
              <img src="../assets/images/gallery/ayu_04.webp" alt="女装娘あゆ" loading="lazy">
            </a>
            <p class="caption">首輪リードで連れ回されたい…</p>
            <div class="gallery-actions">
              <button class="like-btn" onclick="toggleLike('ayu_04')"><span class="like-icon">♡</span><span class="like-count">0</span></button>
              <button class="comment-btn" onclick="openCommentModal('ayu_04')">💬 <span class="comment-count">0</span></button>
              <button class="view-comments-btn" onclick="viewComments('ayu_04')">📖</button>
            </div>
          </div>
          <!-- 画像5 -->
          <div class="gallery-item" data-image-id="ayu_05">
            <a href="../assets/images/gallery/ayu_05.webp" data-fslightbox="gallery">
              <img src="../assets/images/gallery/ayu_05.webp" alt="女装娘あゆ" loading="lazy">
            </a>
            <p class="caption">マゾ女装娘の本気モード</p>
            <div class="gallery-actions">
              <button class="like-btn" onclick="toggleLike('ayu_05')"><span class="like-icon">♡</span><span class="like-count">0</span></button>
              <button class="comment-btn" onclick="openCommentModal('ayu_05')">💬 <span class="comment-count">0</span></button>
              <button class="view-comments-btn" onclick="viewComments('ayu_05')">📖</button>
            </div>
          </div>
          <!-- 画像6 -->
          <div class="gallery-item" data-image-id="ayu_06">
            <a href="../assets/images/gallery/ayu_06.webp" data-fslightbox="gallery">
              <img src="../assets/images/gallery/ayu_06.webp" alt="女装娘あゆ" loading="lazy">
            </a>
            <p class="caption">ぶっかけ準備完了♡</p>
            <div class="gallery-actions">
              <button class="like-btn" onclick="toggleLike('ayu_06')"><span class="like-icon">♡</span><span class="like-count">0</span></button>
              <button class="comment-btn" onclick="openCommentModal('ayu_06')">💬 <span class="comment-count">0</span></button>
              <button class="view-comments-btn" onclick="viewComments('ayu_06')">📖</button>
            </div>
          </div>
          <!-- 画像7 -->
          <div class="gallery-item" data-image-id="ayu_07">
            <a href="../assets/images/gallery/ayu_07.webp" data-fslightbox="gallery">
              <img src="../assets/images/gallery/ayu_07.webp" alt="女装娘あゆ" loading="lazy">
            </a>
            <p class="caption">恥ずかしいポーズでお待ちしてます</p>
            <div class="gallery-actions">
              <button class="like-btn" onclick="toggleLike('ayu_07')"><span class="like-icon">♡</span><span class="like-count">0</span></button>
              <button class="comment-btn" onclick="openCommentModal('ayu_07')">💬 <span class="comment-count">0</span></button>
              <button class="view-comments-btn" onclick="viewComments('ayu_07')">📖</button>
            </div>
          </div>
          <!-- 画像8 -->
          <div class="gallery-item" data-image-id="ayu_08">
            <a href="../assets/images/gallery/ayu_08.webp" data-fslightbox="gallery">
              <img src="../assets/images/gallery/ayu_08.webp" alt="女装娘あゆ" loading="lazy">
            </a>
            <p class="caption">もっと惨めにしてください…</p>
            <div class="gallery-actions">
              <button class="like-btn" onclick="toggleLike('ayu_08')"><span class="like-icon">♡</span><span class="like-count">0</span></button>
              <button class="comment-btn" onclick="openCommentModal('ayu_08')">💬 <span class="comment-count">0</span></button>
              <button class="view-comments-btn" onclick="viewComments('ayu_08')">📖</button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="mb-3 pb-3 border-bottom">
          <div class="d-flex align-items-start">
            ...
            <div>
              ...
              <div class="fs-6">2026年2月14日（土）<br>13:00〜16:00</div>
            </div>
          </div>
        </div>
    ...
    <div class="card shadow-sm mb-3">
      ...
      <div class="card-body">
        <div class="timeline">
          ...
          <div class="timeline-item mb-3 pb-3 border-bottom">
            <div class="d-flex align-items-start">
              <div class="timeline-time text-primary fw-bold me-3" style="min-width: 80px;">15:30</div>
              <div class="timeline-content flex-grow-1">
    ...
    <div class="card shadow-sm mb-3">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-8">2026年2月13日（金）まで</div>
        </div>
      </div>
    </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title">💬 コメントを書く</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <div class="remaining-info">
            本日の残り投稿回数: <strong id="remaining-comments">3</strong>回
          </div>
          <input type="hidden" id="comment-image-id">
          ...
          <div class="mb-3">
            <textarea id="comment-text" class="form-control" rows="4" placeholder="コメントを入力してください（500文字以内）" maxlength="500"></textarea>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">キャンセル</button>
          <button type="button" class="btn btn-primary" id="comment-submit-btn" onclick="submitComment()">送信</button>
        </div>
      </div>
    </div>
  </div>
